...
CREATE TABLE IF NOT EXISTS 7_reservas (
 ...
 PRIMARY KEY (id),
 CONSTRAINT FOREIGN KEY (usuarios_id) REFERENCES 7_usuarios(id),
 CONSTRAINT FOREIGN KEY (alojamientos_id) REFERENCES 7_alojamientos(id)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
/*(NULL, fechaInicio, fechaFin, clientes_id, alojamiento_id)*/
INSERT INTO 7_reservas VALUES (NULL, '2020-06-01', '2020-07-14', 1, 1);
INSERT INTO 7_reservas VALUES (NULL, '2020-06-02', '2020-07-13', 1, 3);
INSERT INTO 7_reservas VALUES (NULL, '2020-06-03', '2020-07-12', 2, 2);
INSERT INTO 7_reservas VALUES (NULL, '2020-06-04', '2020-07-11', 3, 4);
INSERT INTO 7_reservas VALUES (NULL, '2020-06-05', '2020-07-10', 4, 5);
INSERT INTO 7_reservas VALUES (NULL, '2020-06-06', '2020-07-09', 5, 6);
INSERT INTO 7_reservas VALUES (NULL, '2020-06-07', '2020-07-15', 6, 7);
INSERT INTO 7_reservas VALUES (NULL, '2020-06-08', '2020-07-16', 7, 9);
INSERT INTO 7_reservas VALUES (NULL, '2020-06-09', '2020-07-17', 8, 8);
INSERT INTO 7_reservas VALUES (NULL, '2020-06-15', '2020-07-23', 9, 2);
INSERT INTO 7_reservas VALUES (NULL, '2020-06-16', '2020-07-28', 10, 3);
